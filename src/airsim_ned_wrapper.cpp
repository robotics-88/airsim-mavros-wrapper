...
// constexpr char AirsimNEDWrapper::K_YML_NAME[];
// constexpr char AirsimNEDWrapper::D_YML_NAME[];
// constexpr char AirsimNEDWrapper::R_YML_NAME[];
// constexpr char AirsimNEDWrapper::P_YML_NAME[];
// constexpr char AirsimNEDWrapper::DMODEL_YML_NAME[];
...
void AirsimNEDWrapper::create_ros_pubs_from_settings_json()
{
    ...
    // gimbal_angle_quat_cmd_sub_ = nh_private_.subscribe("gimbal_angle_quat_cmd", 50, &AirsimNEDWrapper::gimbal_angle_quat_cmd_cb, this);
    // gimbal_angle_euler_cmd_sub_ = nh_private_.subscribe("gimbal_angle_euler_cmd", 50, &AirsimNEDWrapper::gimbal_angle_euler_cmd_cb, this);
    ...
    for (const auto& curr_vehicle_elem : AirSimSettings::singleton().vehicles) {
        ...
        if (airsim_mode_ == AIRSIM_MODE::DRONE) {
            ...
            //     1,
            //     boost::bind(&AirsimNEDWrapper::vel_cmd_body_frame_cb, this, _1, vehicle_ros->vehicle_name));
            ...
            //     1,
            //     boost::bind(&AirsimNEDWrapper::vel_cmd_world_frame_cb, this, _1, vehicle_ros->vehicle_name));
            ...
            //     boost::bind(&AirsimNEDWrapper::takeoff_srv_cb, this, _1, _2, vehicle_ros->vehicle_name));
            ...
            //     boost::bind(&AirsimNEDWrapper::land_srv_cb, this, _1, _2, vehicle_ros->vehicle_name));
            ...
            //     1,
            //     boost::bind(&AirsimNEDWrapper::car_cmd_cb, this, _1, vehicle_ros->vehicle_name));
    ...
    //     takeoff_all_srvr_ = nh_private_.advertiseService("all_robots/takeoff", &AirsimNEDWrapper::takeoff_all_srv_cb, this);
    //     land_all_srvr_ = nh_private_.advertiseService("all_robots/land", &AirsimNEDWrapper::land_all_srv_cb, this);

    //     // gimbal_angle_quat_cmd_sub_ = nh_.subscribe("gimbal_angle_quat_cmd", 50, &AirsimNEDWrapper::gimbal_angle_quat_cmd_cb, this);

    //     vel_cmd_all_body_frame_sub_ = nh_private_.subscribe("all_robots/vel_cmd_body_frame", 1, &AirsimNEDWrapper::vel_cmd_all_body_frame_cb, this);
    //     vel_cmd_all_world_frame_sub_ = nh_private_.subscribe("all_robots/vel_cmd_world_frame", 1, &AirsimNEDWrapper::vel_cmd_all_world_frame_cb, this);

    //     vel_cmd_group_body_frame_sub_ = nh_private_.subscribe("group_of_robots/vel_cmd_body_frame", 1, &AirsimNEDWrapper::vel_cmd_group_body_frame_cb, this);
    //     vel_cmd_group_world_frame_sub_ = nh_private_.subscribe("group_of_robots/vel_cmd_world_frame", 1, &AirsimNEDWrapper::vel_cmd_group_world_frame_cb, this);

    //     takeoff_group_srvr_ = nh_private_.advertiseService("group_of_robots/takeoff", &AirsimNEDWrapper::takeoff_group_srv_cb, this);
    //     land_group_srvr_ = nh_private_.advertiseService("group_of_robots/land", &AirsimNEDWrapper::land_group_srv_cb, this);
    // }
...
// bool AirsimNEDWrapper::takeoff_srv_cb(airsim_ros_pkgs::Takeoff::Request& request, airsim_ros_pkgs::Takeoff::Response& response, const std::string& vehicle_name)
// {
...
// bool AirsimNEDWrapper::takeoff_group_srv_cb(airsim_ros_pkgs::TakeoffGroup::Request& request, airsim_ros_pkgs::TakeoffGroup::Response& response)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// bool AirsimNEDWrapper::takeoff_all_srv_cb(airsim_ros_pkgs::Takeoff::Request& request, airsim_ros_pkgs::Takeoff::Response& response)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// bool AirsimNEDWrapper::land_srv_cb(airsim_ros_pkgs::Land::Request& request, airsim_ros_pkgs::Land::Response& response, const std::string& vehicle_name)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// bool AirsimNEDWrapper::land_group_srv_cb(airsim_ros_pkgs::LandGroup::Request& request, airsim_ros_pkgs::LandGroup::Response& response)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// bool AirsimNEDWrapper::land_all_srv_cb(airsim_ros_pkgs::Land::Request& request, airsim_ros_pkgs::Land::Response& response)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// bool AirsimNEDWrapper::reset_srv_cb(airsim_ros_pkgs::Reset::Request& request, airsim_ros_pkgs::Reset::Response& response)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
tf2::Quaternion AirsimNEDWrapper::get_tf2_quat(const msr::airlib::Quaternionr& airlib_quat) const
{
    return tf2::Quaternion(airlib_quat.x(), airlib_quat.y(), airlib_quat.z(), airlib_quat.w());
}

msr::airlib::Quaternionr AirsimNEDWrapper::get_airlib_quat(const geometry_msgs::Quaternion& geometry_msgs_quat) const
{
    return msr::airlib::Quaternionr(geometry_msgs_quat.w, geometry_msgs_quat.x, geometry_msgs_quat.y, geometry_msgs_quat.z);
}

msr::airlib::Quaternionr AirsimNEDWrapper::get_airlib_quat(const tf2::Quaternion& tf2_quat) const
{
    return msr::airlib::Quaternionr(tf2_quat.w(), tf2_quat.x(), tf2_quat.y(), tf2_quat.z());
}

// void AirsimNEDWrapper::car_cmd_cb(const airsim_ros_pkgs::CarControls::ConstPtr& msg, const std::string& vehicle_name)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
msr::airlib::Pose AirsimNEDWrapper::get_airlib_pose(const float& x, const float& y, const float& z, const msr::airlib::Quaternionr& airlib_quat) const
{
    return msr::airlib::Pose(msr::airlib::Vector3r(x, y, z), airlib_quat);
}

// void AirsimNEDWrapper::vel_cmd_body_frame_cb(const airsim_ros_pkgs::VelCmd& msg, const std::string& vehicle_name)
// void AirsimNEDWrapper::vel_cmd_body_frame_cb(const airsim_ros_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// void AirsimNEDWrapper::vel_cmd_group_body_frame_cb(const airsim_ros_pkgs::VelCmdGroup& msg)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// // void AirsimNEDWrapper::vel_cmd_all_body_frame_cb(const airsim_ros_pkgs::VelCmd::ConstPtr& msg)
// void AirsimNEDWrapper::vel_cmd_all_body_frame_cb(const airsim_ros_pkgs::VelCmd& msg)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// void AirsimNEDWrapper::vel_cmd_world_frame_cb(const airsim_ros_pkgs::VelCmd::ConstPtr& msg, const std::string& vehicle_name)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// void AirsimNEDWrapper::vel_cmd_group_world_frame_cb(const airsim_ros_pkgs::VelCmdGroup& msg)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// void AirsimNEDWrapper::vel_cmd_all_world_frame_cb(const airsim_ros_pkgs::VelCmd& msg)
// {
//     std::lock_guard<std::mutex> guard(drone_control_mutex_);
...
// void AirsimNEDWrapper::gimbal_angle_quat_cmd_cb(const airsim_ros_pkgs::GimbalAngleQuatCmd& gimbal_angle_quat_cmd_msg)
// {
...
// void AirsimNEDWrapper::gimbal_angle_euler_cmd_cb(const airsim_ros_pkgs::GimbalAngleEulerCmd& gimbal_angle_euler_cmd_msg)
// {
//     try {
//         tf2::Quaternion quat_control_cmd;
...
// airsim_ros_pkgs::CarState AirsimNEDWrapper::get_roscarstate_msg_from_car_state(const msr::airlib::CarApiBase::CarState& car_state) const
// {
...
nav_msgs::Odometry AirsimNEDWrapper::get_odom_msg_from_car_state(const msr::airlib::CarApiBase::CarState& car_state) const
{
...
// airsim_ros_pkgs::Environment AirsimNEDWrapper::get_environment_msg_from_airsim(const msr::airlib::Environment::State& env_data) const
// {
...
// // todo covariances
// sensor_msgs::Imu AirsimNEDWrapper::get_imu_msg_from_airsim(const msr::airlib::ImuBase::Output& imu_data) const
// {
...
// airsim_ros_pkgs::GPSYaw AirsimNEDWrapper::get_gps_msg_from_airsim_geo_point(const msr::airlib::GeoPoint& geo_point) const
// {
...
void AirsimNEDWrapper::update_commands()
{
    // for (auto& vehicle_name_ptr_pair : vehicle_name_ptr_map_) {
    //     auto& vehicle_ros = vehicle_name_ptr_pair.second;
...
// void AirsimNEDWrapper::read_params_from_yaml_and_fill_cam_info_msg(const std::string& file_name, sensor_msgs::CameraInfo& cam_info) const
// {
